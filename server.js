...
const mailOptions = {
  ...
  <body style="margin: 0; padding: 0; background-color: #f7f8fc; font-family: 'Poppins', sans-serif;">
    ...
    ">
      <div class="email-logo" style="text-align: center; margin-bottom: 15px;">
        <img 
          src="https://res.cloudinary.com/dmv2tjzo7/image/upload/v1747914984/b89pwcsfxvyar5jj2i43.jpg" 
          alt="Zuppa Logo"
          style="width: 120px; border-radius: 8px;"
        />
      </div>

      <h2 class="email-title" style="
        text-align: center;
        color: rgb(255,136,0);
        margin-bottom: 10px;
      ">
        Welcome to Zuppa Simulation
      </h2>

      <p class="email-text" style="font-size: 16px; line-height: 1.6; text-align: justify; margin-bottom: 20px;">
        Hello <b>${username}</b>,<br><br>
        We’re thrilled to have you onboard! 🎉<br>
        Your account has been successfully created with <b>Zuppa Simulation</b>.
      </p>

      <p class="email-text" style="font-size: 15px; line-height: 1.6; text-align: justify;">
        Explore our innovative products and experience the future of simulation technology.
      </p>
      ...
      <div class="footer" style="
        ...
        margin-top: 25px;
      ">
        <p style="margin: 4px 0;">📞 <b>9952081655</b></p>
        <p style="margin: 4px 0;">✉️ <b>Sales Enquiries:</b> sales@zuppa.io</p>
        <p style="margin: 4px 0;">🌐 
          <a href="https://shop.zuppa.io" style="color: rgb(255,136,0); text-decoration: none;">
            shop.zuppa.io
          </a>
        </p>
        <p style="font-size: 13px; margin-top: 10px; color: #ccc;">
          © 2024 Zuppa Geo Navigation. All rights reserved.
        </p>
      </div>
    </div>
  </body>
